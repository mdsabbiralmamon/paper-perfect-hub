...
const Services = () => {
    ...
    const cards = [
        ...
        },
        {
            title: 'Lab Reports',
            href: '/request/sheets',
            content: 'Need help with your lab report? We assist in creating clear, concise, and scientifically accurate lab reports, ensuring all data, experiments, and conclusions are well-documented.',
            image: 'https://i.ibb.co.com/MN8trXS/report-10150833.png'
        },
    ]
        ...
        <div className='mx-auto max-w-7xl py-10'>
            <div className="container mx-auto p-6">
                ...
                <div className="grid grid-cols-2 lg:grid-cols-6 gap-4">
                    {cards?.map(card =>
                        <Link key={card?.title} className="service-card bg-white rounded-lg shadow-lg p-3 md:p-6" href={card?.href}>
                            <div>
